                                  ...
                                  int flags)
{
  ...
  */
  index= mutex_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < mutex_class_max)
  {
    ...
    */
    mutex_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
    return (index + 1);
  }
                                   ...
                                   int flags)
{
  ...
  index= rwlock_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < rwlock_class_max)
  {
    ...
    /* Set user-defined configuration options for this instrument */
    configure_instr_class(entry);
    rwlock_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
    return (index + 1);
  }
                                 ...
                                 int flags)
{
  ...
  index= cond_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < cond_class_max)
  {
    ...
    /* Set user-defined configuration options for this instrument */
    configure_instr_class(entry);
    cond_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
    return (index + 1);
  }
                                     ...
                                     int flags)
{
  ...
  index= thread_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < thread_class_max)
  {
    ...
    thread_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
    return (index + 1);
  }
                                 ...
                                 int flags)
{
  ...
  index= file_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < file_class_max)
  {
    ...
    /* Set user-defined configuration options for this instrument */
    configure_instr_class(entry);
    file_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
                                   ...
                                   int flags)
{
  ...
  index= stage_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < stage_class_max)
  {
    ...
    /* Set user-defined configuration options for this instrument */
    configure_instr_class(entry);
    stage_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
                                           ...
                                           int flags)
{
  ...
  index= statement_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < statement_class_max)
  {
    ...
    /* Set user-defined configuration options for this instrument */
    configure_instr_class(entry);
    statement_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
                                     ...
                                     int flags)
{
  ...
  index= socket_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < socket_class_max)
  {
    ...
    /* Set user-defined configuration options for this instrument */
    configure_instr_class(entry);
    socket_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
    return (index + 1);
  }
                                     ...
                                     int flags)
{
  ...
  index= memory_class_dirty_count.fetch_add(1, std::memory_order_relaxed);
  ...
  if (index < memory_class_max)
  {
    ...
    memory_class_allocated_count.fetch_add(1, std::memory_order_relaxed);
    return (index + 1);
  }
